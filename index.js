...
const config = {
    A187: '👾FastBot👾', // TOBAT SU ASU
    instagram: 'https://instagram.com/fanbaseah', // INFO JANGAN DI UBAH
    nomer: 'wa.me/62822843844980', // INFO SU JNGAN DI UBAH
    youtube: 'Tidak Ada', // KINTIL
    whatsapp: 'https://chat.whatsapp.com/BIxGK6yMjlY0yKKaqeuot2', // BABI
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["62822843844980@s.whatsapp.net"] // ganti nomer lu
